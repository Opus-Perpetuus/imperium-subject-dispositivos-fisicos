...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-dispositivos-fisicos"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-dispositivos-fisicos"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-dispositivos-fisicos \
    KIRLET_TECHNICAL_ID=subject-dispositivos-fisicos \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
